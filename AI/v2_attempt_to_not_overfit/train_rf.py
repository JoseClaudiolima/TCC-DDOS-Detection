...
model = RandomForestClassifier(
    n_estimators=100,
    max_depth=10,  # Limita o tamanho das árvores
    min_samples_split=10,  # Evita divisão por poucos exemplos
    min_samples_leaf=5,    # Garante que folhas não fiquem muito específicas
    random_state=42
)
