...
# ============================
model = joblib.load("AI/v3_attempt_to_not_overfit/modelo_ddos_binary.pkl")
le = joblib.load("AI/v3_attempt_to_not_overfit/label_encoder_binary.pkl")
scaler = joblib.load("AI/v3_attempt_to_not_overfit/scaler_binary.pkl")
